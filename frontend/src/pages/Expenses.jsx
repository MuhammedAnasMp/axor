...
export default function Expenses() {
  ...
  const pag = usePagination(api.expenses.list, 10, currentTab === 'history' || (isMobile && (currentTab === 'add' || currentTab === 'expense')));

  // Paginated income history hook
  const incomePag = usePagination(api.incomes.list, 10, currentTab === 'income-history' || (isMobile && currentTab === 'income'));
